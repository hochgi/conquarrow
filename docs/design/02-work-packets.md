...
| P41 | Mirrored spawner field | setup | §2, §4, §7, §11 48 | P03, P08, P36 | **[packet](./packets/P41-mirrored-spawner-field.md)** — spec written, unbuilt. Sample the thinning hash at the reflection orbit representative so the field is exactly mirror-symmetric like the homes. Verify the reflection helper first. |
