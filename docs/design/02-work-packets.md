...
| P42 | Claim walk ignores firebreaks | rules | §6.1, §7, §11 42/49 | P05b, P22 | **[packet](./packets/P42-claim-walk-ignores-firebreaks.md).** Playtest: unanchored landing painted only up to a mid sentry. Repeals P22 D5 / item 42 — firebreaks halt evaporation, not the claim walk. Packet logged; spec-to-ship pending. |
