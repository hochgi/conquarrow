...
import { grainDistanceToAny, homewardPath } from './botEvaluate';
...
/**
 * Beam reply-search is parked for MCP (no `chooseTurnBeam`). Unbound
 * `exposureForBot` would return 0 anyway; keep greedy-v1 off that path.
 */
